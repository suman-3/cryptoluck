...
const ContestCard = ({
  ...
  return (
    <Card
      className={cn(
        className,
        "w-full bg-transparent backdrop-blur-sm rounded-xl h-fit flex flex-col gap-2 items-center justify-start relative border-white/40 min-h-[50vh] p-2 "
      )}
    >
      <Image
        src={profileImage}
        ...
        width={100}
        height={100}
        className="w-full object-cover select-none rounded-lg"
      />
      <div className="flex flex-col gap-3 w-full pb-2">
        ...
        <div className="w-full flex items-center justify-between px-2">
          <p className="text-white text-xs">Raffle No: {raffleNo}</p>
          <Image
            src="/domain/contest/ticket.svg"
            alt="ticket"
            width={100}
            height={100}
            className="size-6 shrink-0 object-cover select-none"
          />
        </div>
        <div className="w-full flex flex-col gap-1 items-start justify-center px-2 -mt-2 mb-2">
          ...
          <div className="flex flex-col gap-1 w-full">
            <h1 className="text-sm text-white">
              {ticketsRemaining}{" "}
              <span className="text-xs">Ticket Remaining</span>
            </h1>
