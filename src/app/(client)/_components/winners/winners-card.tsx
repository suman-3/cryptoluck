...
const WinnerCard = ({
    ...
    return (
        <Card className={cn(className, "bg-transparent backdrop-blur-sm rounded-xl h-fit flex flex-col gap-5 items-center justify-start relative border-white/30 min-h-[50vh] pt-14")}>
            ...
            <Image src={profileImage} alt="profile" width={100} height={100} className="w-16 h-16 rounded-full object-cover select-none" />
            <div className="flex flex-col gap-2">
                ...
                on winning <span className="text-custom-blue">Contest 3</span>
                </p>
            </div>
